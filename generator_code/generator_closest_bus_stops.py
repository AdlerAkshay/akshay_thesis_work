...
class ImprovedGenerator:
    ...
    def cal_closest_bus_stop(self):
        ...
        try:
            with open(self.demand_file_inter_csv, newline='') as csv_file, open(self.final_demand_file, "w",
                                                                                newline='') as f_output:
                reader = csv.DictReader(csv_file)
                ...
                for row in reader:
                    ...
                    closest_starting_bus_stop_edge_id = self.edge_id_to_node_id[
                        self._use_network_shortest_path(start_edge_id)]
                    closest_ending_bus_stop_edge_id = self.edge_id_to_node_id[
                        self._use_network_shortest_path(end_edge_id)]
