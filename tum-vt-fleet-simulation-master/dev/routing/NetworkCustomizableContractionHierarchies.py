...
from src.routing.customizable_contraction_hierarchies_router.PyNetwork import PyNetwork
...
class NetworkCustomizableContractionHierarchies(NetworkBasic):
